...
package dev.ua.ikeepcalm.queueupnow.telegram.modules.system.commands;
        ...
        String helpText = """
                *ВСЕ ВІДНОСНО ЧЕРГ*
                ...
                """
                        ...
                        /increase \\[@Користувач] \\[к-сть] - Додати користувачу повагу
                        /decrease \\[@Користувач] \\[к-сть] - Відняти повагу в користувача
