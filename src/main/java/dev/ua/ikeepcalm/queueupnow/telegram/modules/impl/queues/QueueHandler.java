package dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues;

import dev.ua.ikeepcalm.queueupnow.telegram.modules.HandlerParent;
import dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.callbacks.DeleteCallback;
import dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.callbacks.ExitCallback;
import dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.callbacks.JoinCallback;
import dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.callbacks.NotifyCallback;
import dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.callbacks.mixed.ShuffleCallback;
import dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.commands.MixedCommand;
...
public class QueueHandler implements HandlerParent {
    ...
    private final dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.callbacks.mixed.JoinCallback mixedJoinCallback;
    ...
    public QueueHandler(QueueCommand queueCommand,
                        ...
                        dev.ua.ikeepcalm.queueupnow.telegram.modules.impl.queues.callbacks.mixed.JoinCallback mixedJoinCallback, ShuffleCallback shuffleCallback,
