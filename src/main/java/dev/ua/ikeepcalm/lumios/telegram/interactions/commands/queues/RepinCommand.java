                    ...
                    for (SimpleQueue simpleQueue : simpleQueues) {
                        ...
                        try {
                            ...
                            if (sent != null) {
                                ...
                                editMessage.setText("Щось пішло не так! Не зміг прикріпити " + simpleQueue.getAlias() + "!");
                            }
                        }
                    }
                    ...
                    for (MixedQueue mixedQueue : mixedQueues) {
                        ...
                        try {
                            ...
                            if (sent != null) {
                                ...
                                editMessage.setMessageId(sent.getMessageId());
                                editMessage.setChatId(sent.getChatId());
                                editMessage.setText("Щось пішло не так! Не зміг прикріпити " + mixedQueue.getAlias() + "!");
                            }
                        }
                    }
                }
