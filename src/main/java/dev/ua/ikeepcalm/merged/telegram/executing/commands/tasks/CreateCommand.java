...
public class CreateCommand extends Executable {
    public void execute(Message origin) {
        ...
        if (parts.length >= 3) {
            ...
            String taskName = String.join(" ", Arrays.copyOfRange(parts, 2, parts.length));
            try {
            ...
            sendMessage(origin, "Неповна команда. Будь ласка, використовуйте /task dd.MM.yyyy HH:mm назва");
        }
