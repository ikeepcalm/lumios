...
import dev.ua.ikeepcalm.merged.patterns.CommandPatterns.AdditionCommand;
...
extends Executable {
    public void execute(Message origin) {
        if (AdditionCommand.isAddCommand(origin)) {
