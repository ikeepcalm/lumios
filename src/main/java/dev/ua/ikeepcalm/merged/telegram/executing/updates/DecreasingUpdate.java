...
extends Executable {
    public void execute(Update origin) {
        ...
        if (dev.ua.ikeepcalm.merged.patterns.UpdatePatterns.DecreasingUpdate.isDecreasingUpdate(origin) && !user.equals((Object)repliedUser) && !repliedUser.getIsBot().booleanValue()) {
