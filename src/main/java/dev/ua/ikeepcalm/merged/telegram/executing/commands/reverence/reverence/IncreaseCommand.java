...
import dev.ua.ikeepcalm.merged.patterns.CommandPatterns.IncreasingCommand;
...
extends Executable {
    public void execute(Message origin) {
        if (IncreasingCommand.isAddCommand(origin)) {
